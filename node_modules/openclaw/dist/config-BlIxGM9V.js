...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-Dkp9uP6G.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BTbG3dib.js"), import("./logging-BpWsO2t6.js")]).then(([sdkModule, loggingModule]) => ({
