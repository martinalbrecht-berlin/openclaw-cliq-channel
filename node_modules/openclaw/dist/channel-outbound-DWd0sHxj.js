...
const loadChannelMessageRuntimeModule = async () => {
	channelMessageRuntimeModulePromise ??= import("./runtime-CoIRIvLg.js");
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-CElgH0Bc.js")).deliverInboundReplyWithMessageSendContext(...args);
};
