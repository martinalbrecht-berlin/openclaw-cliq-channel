...
import { t as resolveMemoryBackendConfig } from "../../backend-config-16zpywt8.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-CJYHoTLt.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CKG9WyW0.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-DO8NeDSi.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-DQdYRmK0.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-B6Nmy7lb.js");
