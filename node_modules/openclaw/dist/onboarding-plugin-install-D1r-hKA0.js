...
import { a as installPluginFromNpmSpec, i as installPluginFromNpmPackArchive } from "./install-BO_jrkON.js";
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-DbLrA7aH.js";
import { t as invalidatePluginRuntimeDiscoveryAfterConfigMutation } from "./plugins-registry-refresh-B6UMFngN.js";
...
async function installPluginFromClawHubSpecWithProgress(params) {
	...
	try {
		const { installPluginFromClawHub } = await import("./clawhub-BKEEFiCw.js");
