...
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-BvDdPqDN.js";
...
import { F as resolveGroupSessionKey, G as parseSessionThreadInfoFast, H as resolveMaintenanceConfigFromInput, et as resolveSessionStoreEntry, j as deriveSessionMetaPatch } from "./store-jR_nVe0n.js";
...
import { l as commitReplySessionInitialization, p as loadReplySessionInitializationSnapshot } from "./session-accessor-DvSc996e.js";
...
import { d as ensureAgentWorkspace, m as isWorkspaceBootstrapPending } from "./workspace--BzZU8fC.js";
...
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-CI5HQtMT.js";
...
import { c as resolveIngressWorkspaceOverrideForSpawnedRun } from "./subagent-spawn-plan-CjHejvY2.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { _ as skipDirectiveArgPrefix, d as buildPersistedUserTurnMediaInputsFromFields, f as createUserTurnTranscriptRecorder, g as extractQueueDirective, h as resolvePersistedUserTurnText, t as resolveQueueSettings, v as takeDirectiveToken } from "./queue-vaN7ur-6.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-D45YLDvZ.js";
import { r as getCliSessionBinding } from "./cli-session-DmgIxj4n.js";
import { n as forkSessionFromParent, r as resolveParentForkDecision } from "./session-fork-RracU97k.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CivYFixE.js";
...
import { a as resolveCurrentTurnImages, n as resolveEffectiveReplyRoute, r as createReplyTimingTracker, s as resolveSilentReplySettings, t as isSystemEventProvider } from "./effective-reply-route-DqDkPy-n.js";
...
import { c as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-DkYsxS55.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CfwqQ3uP.js";
...
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as createReplySessionEntryHandle } from "./typing-policy-DvqGJQVy.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-9ECR4XNT.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-B7u0OW4J.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-D7rTJxtb.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection--EvIXFbs.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-BjgmHBWu.js";
...
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-FTr9VQIw.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CC_VBhy_.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DUmYfDqP.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-BwTBCE7R.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-DG2TG5OB.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-DV3EGKCX.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-CAv0MMNx.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-34eqI7hI.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-ByNEiccN.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-1fwSIDZB.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-CoIRIvLg.js");
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-1fwSIDZB.js");
