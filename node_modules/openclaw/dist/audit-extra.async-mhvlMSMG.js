...
function loadSkillsModule() {
	skillsModulePromise ??= import("./workspace-ZDGpU-mC.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-D47Q6HJs.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-FCc69jZD.js");
...
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-CO-GwNQL.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-D7VYO7WN.js");
