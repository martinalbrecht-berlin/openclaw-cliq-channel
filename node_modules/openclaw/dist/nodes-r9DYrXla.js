...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Df_bkBkm.js";
...
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DGrtdbSJ.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-C72ps54F.js";
...
import { d as resolveApprovalRequestRecipientConnIds } from "./approval-shared-DSFYVdQ3.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CXLa1oIm.js");
