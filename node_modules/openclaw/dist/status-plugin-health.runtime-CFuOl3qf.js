...
import { r as resolveReadOnlyChannelPluginsForConfig } from "./read-only-Bv4jseJd.js";
...
async function collectInstalledPluginHealthSnapshot(params) {
	const { buildPluginCompatibilityNotices, buildPluginSnapshotReport } = await import("./status-BT3iwt47.js");
