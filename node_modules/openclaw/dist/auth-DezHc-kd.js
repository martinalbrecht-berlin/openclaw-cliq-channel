...
import { c as loadAuthProfileStoreForRuntime } from "./store-bSl2JOGH.js";
...
import { i as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-BWzBFEqt.js";
import { n as listProfilesForProvider } from "./profile-list-CtT2BW_g.js";
import { n as clearAuthProfileCooldown } from "./usage-BrCGumq-.js";
...
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Vg3w7oUR.js";
...
import { a as loadValidConfigOrThrow, d as updateConfig, s as resolveKnownAgentId } from "./shared-Bs24dOMu.js";
import { t as isRemoteEnvironment } from "./remote-env-UQ1pRGc-.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-D-pQwROU.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-DqWcKPW2.js");
			await openUrl(url);
		},
