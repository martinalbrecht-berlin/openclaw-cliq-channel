...
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-Buyicj8j.js";
import { r as isNonFatalSystemdInstallProbeError } from "./systemd-CSzQEG8q.js";
...
import { t as resolveGatewayInstallToken } from "./gateway-install-token-CGGNtDax.js";
import { a as findTailscaleBinary } from "./tailscale-Dw8WT6Ns.js";
import { F as ConfigMutationConflictError, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, r as createConfigIO } from "./io-9CAVAPVZ.js";
import "./config-Dpm7ICBa.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-Dz7JWeRI.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-BoluiVmq.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-ryMkxneM.js";
...
import { n as applyAuthChoice } from "./auth-choice-Zij6lCRX.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DOJuYSBY.js";
import { i as setupChannels } from "./onboard-channels-C-vAzUNx.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CsXcEckS.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-KamF-GTU.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Dfbm_0W8.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DisJr7KI.js";
import { t as applyPrimaryModel } from "./provider-model-primary-Buacc2fW.js";
import { t as promptCustomApiConfig } from "./onboard-custom-C0dqbnbE.js";
...
import { r as formatHealthCheckFailure } from "./health-format-DBko8zKW.js";
import { a as healthCommand } from "./health-CYZzuqvJ.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BrwPQXeF.js";
import { t as setupSkills } from "./onboard-skills-CcMQXGzd.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-B5HBrlgu.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DdV23l8Y.js");
