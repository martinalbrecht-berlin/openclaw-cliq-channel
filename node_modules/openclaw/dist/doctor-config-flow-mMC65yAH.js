...
import { R as resolveNormalizedProviderModelMaxTokens } from "./io-9CAVAPVZ.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-lez1us6q.js";
...
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-ETrav_2c.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BvybH7Yc.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BN0vMAGf.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-B2z5ms4V.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BQN5ozc4.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-ChoUL8rO.js");
