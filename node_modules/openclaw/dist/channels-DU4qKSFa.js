...
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-9CAVAPVZ.js";
...
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-Bv4jseJd.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CeWqyIH-.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CHoJ_1EB.js";
...
import { t as requireValidConfigFileSnapshot } from "./config-validation-BFwpCY8X.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BEvFtV4i.js";
import { t as channelsListCommand } from "./list-Dh7uXcnV.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-C76oHvJc.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CtblWSAV.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-C-QLqD_C.js"));
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-rjl2kaye.js"), loadOnboardChannels()]);
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BVeq7zNh.js");
