...
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-CPEpF8QC.js";
import { o as normalizeProviderId } from "./model-selection-normalize-Df7baLev.js";
import "./model-selection-dHF0ko3X.js";
import { ht as generateSummary$1 } from "./sessions-JU-Nr-nC.js";
import { a as buildStageSplitPlan, i as buildOversizedFallbackPlan, l as sanitizeCompactionMessages, o as buildSummaryChunks, r as buildHistoryPrunePlan, s as computeAdaptiveChunkRatio } from "./compaction-planning-DNCdhmpK.js";
...
import { r as isDeliveredMessagingToolResult, t as hasMessagingDeliveryReceipt, v as isToolResultError } from "./embedded-agent-message-tool-source-reply-CxlXqCQX.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-CEDW5g5E.js");
