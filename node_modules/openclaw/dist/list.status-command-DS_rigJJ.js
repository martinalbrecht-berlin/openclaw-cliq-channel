...
import { r as createConfigIO } from "./io-9CAVAPVZ.js";
...
import { P as evaluateStoredCredentialEligibility, i as ensureAuthProfileStoreWithoutExternalProfiles, v as loadPersistedAuthProfileStore } from "./store-bSl2JOGH.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-CqVcoNpy.js";
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Cb_NPY4Q.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-9DszqBST.js";
import "./profiles-BWzBFEqt.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-BrCGumq-.js";
...
import { h as resolveUsableCustomProviderApiKey, o as getCustomProviderApiKey } from "./model-auth-Bjx4UCgB.js";
import "./workspace--BzZU8fC.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-wDx6WgK1.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-Bs24dOMu.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-5tpLDsZm.js";
import { t as maskApiKey } from "./mask-api-key-D2MLa8WN.js";
import { t as loadModelsConfig } from "./load-config-Bh0DxSV2.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-X-IcQbJh.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-CE320ycN.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-DR0gRZE5.js");
			runtime.log("");
