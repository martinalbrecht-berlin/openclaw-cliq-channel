...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-Dkp9uP6G.js";
import "./config-BlIxGM9V.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-BTbG3dib.js"), import("./logging-BpWsO2t6.js")]).then(([sdkModule, loggingModule]) => ({
