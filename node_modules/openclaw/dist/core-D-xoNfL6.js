...
import "./resolve-route-C9SpNvHo.js";
...
import "./persistent-bindings.resolve-DvgFpm77.js";
...
async function ensureConfiguredAcpBindingReady(params) {
	return (await import("./persistent-bindings.lifecycle-DbsOCIQz.js")).ensureConfiguredAcpBindingReady(params);
}
