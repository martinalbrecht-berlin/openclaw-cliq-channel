...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-DPn8NgHI.js";
...
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-bSl2JOGH.js";
import { E as listMemoryEmbeddingProviders } from "./registry-BXwW-HDh.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-dHF0ko3X.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-CMTALpUD.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DuV1a6q_.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-CeWqyIH-.js";
...
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-h4wxczNS.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-Ca7F7Ioz.js";
import "./tts-C8r-nw4p.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DGVPBk-0.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-OBxh2cB6.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-StKvg_iL.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CBXJuehI.js";
import { n as listWebFetchProviders, r as resolveWebFetchDefinition, t as isWebFetchProviderConfigured } from "./runtime-rY8GK0pi.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-CwBZmoHW.js";
import { t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Idh6ZoMO.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-ilY7zRgw.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DS_rigJJ.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DezHc-kd.js");
