...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DuV1a6q_.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-Cx4PF4gn.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-CYRM0mSz.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-C41HwC-G.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-DgJcKdh4.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BuuAbA_M.js");
