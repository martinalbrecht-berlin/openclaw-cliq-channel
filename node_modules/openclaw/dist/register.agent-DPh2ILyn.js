...
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-BcmmBRiX.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-C6XxAp1N.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-CAB-as6R.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-CcU0Nr7Z.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-8Muqu5h1.js")).agentsListCommand;
}
