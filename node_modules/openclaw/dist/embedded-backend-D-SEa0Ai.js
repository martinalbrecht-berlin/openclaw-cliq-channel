...
import { a as applySessionPatchProjection } from "./session-accessor-DvSc996e.js";
...
import { t as buildAllowedModelSet } from "./model-selection-dHF0ko3X.js";
...
import { c as clearSessionGoal, d as getSessionGoal, l as createSessionGoal, p as updateSessionGoalStatus, u as formatSessionGoalStatus } from "./sessions-nxc5fSfR.js";
import { o as readSessionMessagesAsync } from "./session-transcript-readers-Db6LYllm.js";
import { r as ensureContextWindowCacheLoaded } from "./context-M1OpGHXH.js";
import { a as getSessionDefaults, b as resolveSessionModelRef, c as listSessionsFromStoreAsync, d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, o as listAgentsForGateway, t as buildGatewaySessionInfo, u as loadSessionEntry } from "./session-utils-DBBPHeGp.js";
import { D as setEmbeddedMode } from "./openclaw-tools-DnJ9m035.js";
...
import { a as parseGoalCommand } from "./commands-goal-DkYsxS55.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-C-1wtJjC.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-Djr7SA4P.js";
...
import { n as projectSessionsPatchEntry } from "./sessions-patch-CMFGf406.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-KFs_W9Jb.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DigB-M-1.js");
