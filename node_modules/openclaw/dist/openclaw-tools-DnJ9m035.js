...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-9CAVAPVZ.js";
...
import { d as listMediaGenerationProviderModels, f as synthesizeMediaGenerationCatalogEntries } from "./registry-BXwW-HDh.js";
...
import { G as parseSessionThreadInfoFast, _ as updateSessionStore, b as loadSessionStore } from "./store-jR_nVe0n.js";
...
import { _ as normalizeProviderTransportWithPlugin } from "./provider-runtime-Cb_NPY4Q.js";
import "./auth-profiles-9DszqBST.js";
import { n as resolveApiKeyForProfile } from "./oauth-R_OaG_Ep.js";
...
import { i as resolveAuthProfileOrder } from "./order-BiGfOBQl.js";
...
import { r as ensureOpenClawModelsJson } from "./models-config-D4Zt658X.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog, t as resolveThinkingDefault } from "./model-thinking-default-GwbGGXiw.js";
import { c as resolveDefaultModelForAgent, d as resolvePersistedSelectedModelRef, i as normalizeStoredOverrideModel } from "./model-selection-dHF0ko3X.js";
...
import { n as loadModelCatalog } from "./model-catalog-7IG2nf1t.js";
...
import { V as createReadTool, Y as createEditTool, z as createWriteTool } from "./sessions-JU-Nr-nC.js";
...
import { a as getApiKeyForModel, o as getCustomProviderApiKey } from "./model-auth-Bjx4UCgB.js";
...
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-ey_nCwzr.js";
...
import "./runtime-internal-CH2w9wr9.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-CkGwWUlu.js";
...
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-axTpTpGH.js";
import { n as capArrayByJsonBytes } from "./session-utils.fs-CuEupzWa.js";
import { d as getSessionGoal, l as createSessionGoal, p as updateSessionGoalStatus, s as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-nxc5fSfR.js";
...
import { u as readSessionTitleFieldsFromTranscriptAsync } from "./session-transcript-readers-Db6LYllm.js";
...
import { f as pruneLegacyStoreKeys, g as resolveGatewaySessionStoreTarget, r as deriveSessionTitle, y as resolveSessionModelIdentityRef } from "./session-utils-DBBPHeGp.js";
...
import { a as resolvePluginTools } from "./tools-BVgZKS33.js";
...
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-Cql8-Ml_.js";
...
import { c as getToolParamsRecord, f as wrapToolParamValidation, l as normalizeFileToolPathParam, n as resolveNode, o as REQUIRED_PARAM_GROUPS, r as resolveNodeId, s as assertRequiredParams, u as normalizeFileToolPathParamsFromKeys } from "./nodes-utils-BR0o1ZGQ.js";
...
import { r as parseImageGenerationModelRef } from "./provider-registry-CBCfN9uk.js";
import { a as recordCapabilityCandidateFailure, f as throwCapabilityGenerationFailure, h as resolveCapabilityModelRefForProviders, i as normalizeDurationToClosestMax, m as findCapabilityProviderById, n as buildNoCapabilityModelConfiguredMessage, o as resolveCapabilityModelCandidates, p as hasMediaNormalizationEntry, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-GzyWxOz9.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BWZdf2iD.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-Cltz9L96.js";
...
import { r as getDefaultLocalRoots } from "./local-media-access-BeVoHNQP.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-CNJFjfNy.js";
import { a as loadSessionEntryByKey, b as formatGeneratedAttachmentLines, i as loadRequesterSessionEntry, n as deliverSubagentAnnouncement, t as resolveAnnounceOrigin, v as formatAgentInternalEventsForPrompt, x as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-origin-BvcRGpnm.js";
import { i as routeToDeliveryFields, n as routeFromBindingRecord } from "./route-projection-CXY21LPh.js";
import { a as hasInProcessGatewayContext, r as dispatchGatewayMethodInProcess } from "./server-plugins-DQliXuaQ.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-DPh9ARXg.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-B-HKM5_-.js";
import { a as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback-CKB2G2qA.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-BxUr_cOj.js";
...
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-DFCkGOjl.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-BXIsAhqj.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BthtM2hz.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-DuV1a6q_.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BK3bTOCE.js";
import { c as resolveTimeoutMs } from "./resolve-Cx4PF4gn.js";
import "./media-understanding-DRzhEA6T.js";
import { n as resolveModelAsync } from "./model-CN-U_f16.js";
import { c as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-BxAHakWS.js";
import { t as CHANNEL_MESSAGE_ACTION_NAMES } from "./message-action-names-Csg2tRuR.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CfH3NhVu.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CeWqyIH-.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-CglxJANN.js";
import { o as parseInteractiveParam, s as parseJsonMessageParam } from "./message-action-dispatch-Dv-ZtIof.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as stripFormattedReasoningMessage, t as getToolResult } from "./message-action-runner-DlxXNJiv.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-BfCwHZzw.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-QQfSf8Pt.js";
...
import { T as resolveEnabledBundledManifestContractPlugins, w as extractPdfContent } from "./runner.entries-CYRM0mSz.js";
import { c as resolveAnthropicMessagesUrl } from "./provider-stream-B5ruZ4qc.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-IZlFW475.js";
...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-BwoIKijv.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-BZwmp-ZH.js";
...
import { h as registerSubagentRun, i as countActiveRunsForSession } from "./subagent-registry-Bvmo-OI6.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-Ch4Mykew.js";
import { r as resolveInboundConversationResolution, t as resolveChannelDefaultBindingPlacement } from "./conversation-resolution-OA98-MDr.js";
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-DAW2rZA4.js";
import { t as forkSessionEntryFromParent } from "./session-fork-RracU97k.js";
import { t as ensureContextEnginesInitialized } from "./init-CYl4xiRx.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-Bs91RWap.js";
import { a as proposeUpdateSkill, d as reviseSkillProposal, i as proposeCreateSkill, l as rejectSkillProposal, n as inspectSkillProposal, o as quarantineSkillProposal, r as listSkillProposals, t as applySkillProposal, u as resolvePendingSkillProposal } from "./service-DPQqZBtI.js";
import { n as buildSubagentList } from "./subagent-list-D8-qWUdM.js";
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-DvT-t04r.js";
import { a as wrapExternalContent, o as wrapWebContent } from "./external-content-CycSUXwl.js";
import { k as textToSpeech } from "./tts-runtime-Ca7F7Ioz.js";
import "./tts-C8r-nw4p.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DGVPBk-0.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-Dwll_fNC.js";
...
import { a as runWebSearch } from "./runtime-OBxh2cB6.js";
...
async function tryDeliverMediaGenerationDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-C6donMXJ.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-BBGpAwuS.js");
}
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-CoxPcbYq.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BMwsncWA.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-efKEAVm9.js"));
