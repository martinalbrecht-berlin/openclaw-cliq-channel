import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-LiZBYjFY.js";
import { r as loadCrestodianOverview } from "./overview-DPVnb-jK.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CEj_x2VG.js")).planCrestodianCommand)({
		input,
		overview
	});
