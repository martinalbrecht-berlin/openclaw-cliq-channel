...
import { l as hasSyntheticLocalProviderAuthConfig, u as hasUsableCustomProviderApiKey } from "./model-auth-Bjx4UCgB.js";
import { i as formatTokenK, m as createModelCatalogProviderAliasCanonicalizer, n as ensureFlagCompatibility, p as canonicalizeModelCatalogProviderAlias } from "./shared-Bs24dOMu.js";
import { n as loadModelsConfigWithSource } from "./load-config-Bh0DxSV2.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-z-DYzgQk.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-B_Ptbde4.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-DntrLOtU.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BUZtlBrT.js"),
		import("./agent-scope-D47Q6HJs.js"),
		import("./workspace-r70wVLX_.js")
	]);
