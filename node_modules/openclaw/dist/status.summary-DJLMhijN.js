...
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-wDx6WgK1.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-kjCUeRNK.js";
//#region src/commands/status.summary.ts
const RECENT_SESSION_LIMIT = 10;
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-Bc2ovEKj.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-BY20bSXF.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./status.link-channel-vJth9mdF.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-5uiEIh4u.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-DshgegwZ.js");
	return {
