...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-DzdS7Ejv.js";
import { a as resetModelCatalogCache, n as loadModelCatalog } from "./model-catalog-7IG2nf1t.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-Ca1A1PqF.js";
...
import { a as refreshContextWindowCache } from "./context-M1OpGHXH.js";
...
import { r as resetDirectoryCache } from "./target-resolver-BWTwFOHy.js";
...
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Djr7SA4P.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BV95vFh8.js";
...
import { t as buildGatewayCronService } from "./server-cron-DBpvxmBG.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-CFkfTSfe.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-D8S_3H17.js")).activateSecretsRuntimeSnapshot(snapshot);
}
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BM1h51pR.js"), import("./gmail-watcher-lifecycle-BoWwhUTz.js")]);
