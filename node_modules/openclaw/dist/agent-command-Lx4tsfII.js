...
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-9CAVAPVZ.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-BiGfOBQl.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-7IG2nf1t.js";
...
import { W as createTrajectoryRuntimeRecorder, t as resolveAvailableAgentHarnessPolicy } from "./selection-CVIPXpKT.js";
import { s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-CjHejvY2.js";
import { _ as formatAgentInternalEventsForPlainPrompt, v as formatAgentInternalEventsForPrompt } from "./subagent-announce-origin-BvcRGpnm.js";
...
import { o as runWithModelFallback, p as LiveSessionModelSwitchError } from "./model-fallback-CKB2G2qA.js";
import { n as resolveSession } from "./session-CMTALpUD.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-CeWqyIH-.js";
...
import { n as mergeEmbeddedAgentRunResultForModelFallbackExhaustion, t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-D13pndqO.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-C5mvwkpU.js";
import "./live-model-switch-B8SbUtsu.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-ao3KigkP.js";
import { r as createChatRunEntry } from "./server-chat-state-COF_MGQr.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-CC_VBhy_.js";
import { t as NodeRegistry } from "./node-registry-BZLqTDQ7.js";
import { r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-Dq7xEXdR.js";
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-CCAOBXxe.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-D1CR1psw.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-DhWEDfz0.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-CULvOFOE.js"), import("./session-snapshot-0sNzz2dE.js")]);
	return {
