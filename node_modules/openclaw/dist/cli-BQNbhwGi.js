...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-mRPUypDI.js";
import { n as matrixSetupAdapter } from "./setup-core-DVJNdrvd.js";
import { t as withResolvedActionClient } from "./client-HPuhze5U.js";
import { r as resolveMatrixAuthContext } from "./config-BlIxGM9V.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-BSeWIVRW.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-CfdkRGXm.js");
